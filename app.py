...
def detail(keyword):
    api_key = '394c214a-3909-4502-bf75-f2a99b08e7e4'
    ...
    if type(definitions[0]) is str:
        ...
        return redirect(url_for('error', msg=f'Could not find the word, "{keyword}", did you mean one of these words:', suggestions=suggestion))
